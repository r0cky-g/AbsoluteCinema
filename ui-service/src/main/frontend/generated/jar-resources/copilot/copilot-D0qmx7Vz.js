...
const Nt = async (e, t, r) => window.Vaadin.copilot.comm(e, t, r), he = "copilot-", ll = "25.0.0", cl = "undefined", Td = "attention-required", Id = "https://plugins.jetbrains.com/plugin/23758-vaadin", zd = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", Ud = "https://marketplace.eclipse.org/content/vaadin-tools";
function Ld(e) {
...
\f\r"'\`<>=]|("|')|))|$)`, "g"), Gn = /'/g, Yn = /"/g, Ea = /^(?:script|style|textarea|title)$/i, ka = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r }), le = ka(1), Yd = ka(2), ge = Symbol.for("lit-noChange"), E = Symbol.for("lit-nothing"), Qn = /* @__PURE__ */ new WeakMap(), Ae = ze.createTreeWalker(ze, 129);
function Ca(e, t) {
...
function dc() {
  ke.push(import("./copilot-log-plugin-BYreWiP9.js")), ke.push(import("./copilot-info-plugin-CW2NYl-U.js")), ke.push(import("./copilot-features-plugin-tDdqN3rO.js")), ke.push(import("./copilot-feedback-plugin-CGonP0YD.js")), ke.push(import("./copilot-shortcuts-plugin-paBUeVT4.js"));
}
function uc() {
  {
...
const Be = window.Vaadin.copilot.overlayManager, eu = {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: zc } = ic, tu = (e) => e.strings === void 0, ii = () => document.createComment(""), lt = (e, t, r) => {
...
let vi = class extends cc {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-Qgt1h4tX.js"), await import("./copilot-init-step2-B9w7ukRF.js"), bl(), dc(), this.tabIndex = 0, Mt.hostConnectedCallback(), window.addEventListener("keydown", Hr), this.addEventListener("keydown", fi), y.onSend(this.handleSendEvent), this.removers.push(y.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
